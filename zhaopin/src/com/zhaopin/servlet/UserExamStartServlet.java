...
public class UserExamStartServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	 ...
    	 List<Exam> list = cdao.queryexamlist();
    	 request.setAttribute("Examlist", list);

         request.getRequestDispatcher("/userexamstart.jsp").forward(request, response);
    }
